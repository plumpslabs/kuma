...
const CORE_ACTIONS = [
  ...
  "🏛️ **Subsystem clusters:** `kuma_context({ action: \"cluster\" })`",
  "🦴 **File skeleton:** `kuma_context({ action: \"skeleton\", target: \"<file>\" })`",
  "🔍 **Reuse helper:** `kuma_context({ action: \"reuse\", target: \"<intent>\" })`",
